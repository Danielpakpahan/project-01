...
@section('content')
	...
	<ol class="breadcrumb float-xl-right">
		<li class="breadcrumb-item"><a href="javascript:;">Strategic Level</a></li>
		<li class="breadcrumb-item"><a href="javascript:;">Board Affairs</a></li>
		<li class="breadcrumb-item"><a href="javascript:;">Board of Director</a></li>
		<li class="breadcrumb-item"><a href="javascript:;">Protokoler</a></li>
		<li class="breadcrumb-item active">Tambah Activity</li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h1 class="page-header">Form Tambah Activity</h1>
	<!-- end page-header -->
	<!-- begin row -->
	<div class="row">
		<!-- begin col-6 -->
